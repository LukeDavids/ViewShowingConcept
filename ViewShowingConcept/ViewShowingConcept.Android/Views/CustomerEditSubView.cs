...
namespace ViewShowingConcept.Android.Views
{
    ...
    public class CustomerEditSubSubView : BaseSubView<CustomerEditViewModel>
    {

        public CustomerEditSubSubView(SubViewType subViewType) : base(subViewType)
        {
        }

        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            SubViewType = SubViewType.CustomerEdit;
